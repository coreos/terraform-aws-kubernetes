...
module "vpc" {
  source = "github.com/coreos/tectonic-installer//modules/aws/vpc?ref=1.7.5-tectonic.1"
...
module "etcd" {
  source = "github.com/coreos/tectonic-installer//modules/aws/etcd?ref=1.7.5-tectonic.1"
...
module "masters" {
  source = "github.com/coreos/tectonic-installer//modules/aws/master-asg?ref=1.7.5-tectonic.1"
...
module "workers" {
  source = "github.com/coreos/tectonic-installer//modules/aws/worker-asg?ref=1.7.5-tectonic.1"
