...
module "vpc" {
  source = "github.com/coreos/tectonic-installer//modules/aws/vpc?ref=1.7.3-tectonic.2"
...
module "etcd" {
  source = "github.com/coreos/tectonic-installer//modules/aws/etcd?ref=1.7.3-tectonic.2"
...
module "ignition_masters" {
  source = "github.com/coreos/tectonic-installer//modules/aws/ignition?ref=1.7.3-tectonic.2"
...
module "masters" {
  source = "github.com/coreos/tectonic-installer//modules/aws/master-asg?ref=1.7.3-tectonic.2"
...
module "workers" {
  source = "github.com/coreos/tectonic-installer//modules/aws/worker-asg?ref=1.7.3-tectonic.2"
